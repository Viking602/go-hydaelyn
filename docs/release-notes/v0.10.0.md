...
> **Retracted:** The `v0.10.0` tag reused a version already recorded with
> different content in the public Go checksum database. Standard Go module
> verification therefore rejects this version. Use `v0.10.1` instead.
